...
const AIAutomation = () => {
  ...
  return (
    <section className="relative max-w-7xl mx-auto flex flex-col items-center justify-center min-h-screen text-white overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen text-white py-20 px-4">
        ...
        >
          ...
          <p className="text-slate-300 text-xl md:text-2xl max-w-3xl mx-auto mb-10">
            Fyodor empowers businesses with AI and intelligent automation
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-start mb-16">
            ...
            <p className="text-left text-slate-300 text-lg max-w-2xl">
              Unlock the power of artificial intelligence to innovate, automate,
              and scale your business with Fyodor
            </p>
          </div>
      ...
      <div className="relative py-20 px-4 w-full">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            >
              We combine technical expertise with business acumen to deliver AI
              ...
              >
                ...
                <div className="flex items-start gap-5 relative z-10 h-full">
                  <div className="flex-shrink-0">
                    ...
                    >
                      <adv.icon size={24} className={`text-${adv.color}-400`} />
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              className="text-slate-300 text-xl max-w-3xl mx-auto"
            >
              A structured methodology that transforms your business challenges
