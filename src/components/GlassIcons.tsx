...
const gradientMapping: Record<string, string> = {
  blue: 'linear-gradient(hsl(223, 90%, 70%), hsl(208, 90%, 70%))',
  purple: 'linear-gradient(hsl(283, 90%, 70%), hsl(268, 90%, 70%))',
  red: 'linear-gradient(hsl(3, 90%, 70%), hsl(348, 90%, 70%))',
  indigo: 'linear-gradient(hsl(253, 90%, 70%), hsl(238, 90%, 70%))',
  orange: 'linear-gradient(hsl(43, 90%, 70%), hsl(28, 90%, 70%))',
  green: 'linear-gradient(hsl(123, 90%, 60%), hsl(108, 90%, 60%))'
};
